...
class EvolutionGenerator {
  String generateSummary(EvolutionData data, {String? bedLabel}) {
    final lines = <String>[
      ...
      'COMPARE A EVOLUÇÃO FINAL COM O MODELO INDICADO E COLOQUE EM NEGRITO APENAS OS TRECHOS ALTERADOS, SUBSTITUÍDOS OU ACRESCENTADOS EM RELAÇÃO AO MODELO. MANTENHA SEM NEGRITO OS TRECHOS IDÊNTICOS AO MODELO.',
      'REGRA DE SEGURANÇA DE MARKDOWN: NUNCA COLE ASTERISCOS EM PALAVRAS OU PONTUAÇÕES MANTIDAS DO MODELO. QUANDO UMA FRASE TIVER PARTE MANTIDA E PARTE ALTERADA, ESCREVA A PARTE MANTIDA NORMALMENTE, INSIRA A PONTUAÇÃO NORMALMENTE, E SÓ ENTÃO ABRA O NEGRITO ANTES DO TRECHO ALTERADO.',
      'EXEMPLO CORRETO: AFEBRIL, **COM TEMPERATURA MEDIDA DE 34,3°C**.',
      'EXEMPLO INCORRETO: AFEBRIL**, COM TEMPERATURA MEDIDA DE 34,3°C**.',
      'EXEMPLO CORRETO: NORMOTENSA **DURANTE O PERÍODO, COM PA PONTUAL DE 101/59 MMHG**.',
      'EXEMPLO INCORRETO: NORMOTENSA**, COM PA PONTUAL DE 101/59 MMHG**.',
      'ANTES DE RESPONDER, CONFIRA SE TODO ** TEM ABERTURA E FECHAMENTO E SE NÃO HÁ ** SOLTO COLADO A PALAVRAS OU PONTUAÇÕES MANTIDAS DO MODELO.',
